...
/// @param MaskSprite - black and white dissolve pattern. Dimensions must match the sprite to be dissolved!
/// @param MaskFrame - Mask sub-image index
/// @param InnerColour - eg: c_red, or make_colour_rgb())
/// @param OuterColour - eg: c_red, or make_colour_rgb())
/// @param EdgeThickness - from 0 (no colour edge) to 0.99 (full sprite)
